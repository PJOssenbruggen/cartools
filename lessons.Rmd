...
1. __Collect real-time data.__ Collect data  with lidar and radar equipment placed roadside is currently available. Data collected on-board a vehicle with GPS systems, __floating car data__ or __floating cellualr data__ https://en.wikipedia.org/wiki/Floating_car_data, is being developed [@5gaa]. The f Measures, including location $x_{vehicle}(t)$ and speed $u_{vehicle}(t)$  data will be transmitted using wireless technology and stored on a central controller computer.
