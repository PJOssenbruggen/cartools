...
Question (1), the $\$1B$ dollar question, requires further research to provide a good answer. If the  __cartools__  package offers nothing else, a reader must come away knowing that collecting good data  from controlled experiments and the good field data are essential. 
