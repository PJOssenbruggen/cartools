...
Question (1), the $\$1B$ dollar question, requires further research to provide a good answer. If the  __cartools__  package offers nothing else, a reader must come away knowing that collecting good data  from controlled experiments and the good field data are essential. Once these data are obtained meaningful analyses can be conducted. Of course, even when objective is focused on  the understanding the effects of traffic noise and controlling it, an interdisciplinary approach is necessary. This does not mean establishing an academic, interdisciplinary team of computer scientists, engineers and statisticians. @albino state that there is no one formula for success but a clear need to engage policy makers from local communities.  The cities of Chattanooga, TN and Syracuse, NY, have  a good working relationships and a dialog with University of Tennessee and Syracuse University that can be tapped. For example, the SU College of Engineering and Computer Science and its newly established  Invent@SU inventor accelerators has engaged undergraduates in various projects across disciplines and colleges that engage them with local communities in many cities across the country.
