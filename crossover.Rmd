...
Construction of the viaduct began in the late 1950's and early 60's. Much has changed since this time and much can be learned from the past.  Consider using side fire radar to collect vehicle count $n$, speed $u$, vehicle class data at the three sites show above. These data would certainly go along way in testing our __cartools__ methodology to explain and predict traffic breakdown at a bottleneck.  These data can also be used to prepare a I-81 Viaduct level-of-service (LOS) report. A LOS report will complement the NYSDOT I-81 Viaduct Project report that used annual average daily flow as a principal means of reporting LOS. 
...
Engineers also want to minimize the construction costs. The taxpaying public should be pleased that students are learning "building information modeling."  BIM allows engineers to spend more time evaluating what-if scenarios to optimize the design and less time generating construction documentation [@bim]. Incorporating the information derived from computer __cartools__ simulations into BIM is a possibility that should explored.

There are three benefits of traffic data collection: (1) prepare a LOS report, (2) improve BIM, and (3) test __cartools__.
