...
__Delay:__ An experiment consisting of 10 simulations gives the following results. Given the volatility shown immediately above for one simulation, it is no surprise the volatility in speed for 10 simulations is also great. The average speed through the bottleneck merge region dips to a low of 20 mph. 
