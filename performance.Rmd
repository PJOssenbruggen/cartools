...
```{r bottleneck_merge2,  message = FALSE, fig.height = 4, fig.width = 8, echo = FALSE}
par(mfrow = c(1,2))
library(Basic)
library(rlist)
set.seed(127)
lane <- c(0,1,2,1,2)
xstart <- c(-950, -1000, -1050, -1100, -1150)
brktrials(30, 41, 11, xstart, -500, 14, lane, 0.5) -> output
set.seed(1240)
lane <- c(0,1,2,1,2)
xstart <- c(-950, -1050, -1150, -1250, -1350)
brktrials(30, 41, 11, xstart, -500, 14, lane, 0.5) -> output
```
...
Do the simulations suggest that expanding the number of lanes downstream of the bottleneck to reduce land traffic density is a good solution? Good question. History shows that it is not. What can be done? Public transportation is one answer.
