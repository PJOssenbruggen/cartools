...
The following two $t-x$ show effect of traffic volatility on traffic breakdown. The panel of the left shows a queue formation that is quickly moving in the upstream direction, $x < 0$. The panel on the right shows the five vehicles are closely packed.  Speeds decline for the drivers of the following vehicles  downstream of $x > 0$.  The drivers of the lead vehicles experince no decline in service.
