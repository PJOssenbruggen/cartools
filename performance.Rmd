...
library(rlist)
set.seed(127)
lane <- lane <- c(1,1,2,1,2,1,2,1,2,2)
xstart <- c(-900, -995, -1000, -1090, -1100,-1200, -1220, -1320, -1400, -1660)
brktrials2(10, 30, 41, 11, xstart, -500, 14, lane, 0.1, 1) -> output
```

_As you can see, the code must be robust to account volatility in the breakdown process. More debugging is necessary to remove quirky behavior, blank spaces, etc. as illustrated for the last two graphs._ 
